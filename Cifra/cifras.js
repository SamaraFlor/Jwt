...
function cifraMensagem(mensagem, movimentos){
      ...
      return mensagemCifrada.join('');
        ...
        /*O charCodeAt() é um método usado para retornar o número que 
        indica o valor Unicode do caractere no índice especificado.
        */
        ...
        function decode(offset, mensagem) {
          ...
          console.log(decode(1,'BANANA')); //CBOBOB
          console.log(decode(6, 'ZUMBA')); //FASHG